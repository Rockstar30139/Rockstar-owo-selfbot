...
const reloadPresence = async (client:discord.Client) => {
    ...
    const activity = new discord.RichPresence()
        ...
        .setType("STREAMING")
        .setName("ROYAL NUKERS ON TOP BXBY")
        .setDetails("Join Royal Nukers")
        ...
        .setAssetsSmallText("ROYAL NUKERS ON TOP")
        .addButton('Github', "https://discord.com/invite/D28N9Q2xN9")
        .addButton('Youtube', "https://discord.com/invite/D28N9Q2xN9")
